...
public class Web extends WebSecurityConfigurerAdapter
{
    ...
    {
        http.csrf().disable().authorizeRequests().antMatchers("/event/**").hasRole("ADMIN").
                antMatchers("/CSS/**", "/JS/**", "/img/**", "/home", "/denied", "/register").permitAll()
                ...
                .exceptionHandling().accessDeniedHandler(denied);
    }
}